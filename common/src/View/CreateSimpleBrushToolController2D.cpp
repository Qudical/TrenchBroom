    ...
    namespace View {
        ...
        namespace {
            ...
            public:
                ...
                void cancel(const vm::vec3&) override {
                    m_tool.cancel();
                }

                void render(const InputState&, Renderer::RenderContext& renderContext, Renderer::RenderBatch& renderBatch, const vm::vec3& /* initialHandlePosition */, const vm::vec3& /* currentHandlePosition */) const override {
        ...
        std::unique_ptr<DragTracker> CreateSimpleBrushToolController2D::acceptMouseDrag(const InputState& inputState) {
            ...
            return createHandleDragTracker(CreateSimpleBrushDragDelegate{*m_tool, document->worldBounds(), document->referenceBounds()}, inputState, initialHandlePosition);
        }
